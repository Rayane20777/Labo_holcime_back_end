...
use App\Repositories\Implementations\ResulatPhysiqueLpeeRepository;
use App\Repositories\Interfaces\ResulatPhysiqueLpeeRepositoryInterface;
use App\Services\Implementations\ResulatPhysiqueLpeeService;
use App\Services\Interfaces\LpeeServiceInterface;
use App\Repositories\Implementations\LpeeRepository;
use App\Repositories\Interfaces\LpeeRepositoryInterface;
use App\Services\Implementations\LpeeService;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ResulatPhysiqueLpeeServiceInterface::class, ResulatPhysiqueLpeeService::class);
        $this->app->bind(ResulatPhysiqueLpeeRepositoryInterface::class, ResulatPhysiqueLpeeRepository::class);
        $this->app->bind(LpeeServiceInterface::class, LpeeService::class);
        $this->app->bind(LpeeRepositoryInterface::class, LpeeRepository::class);
